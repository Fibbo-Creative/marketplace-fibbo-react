const engLiterals = {
  ...
  detailNFT: {
    ...
    you: "You",
    bidStarts: "Auction starts in {0}  ( {2} )",
    bidEnds: "Auction ends in {0}  ( {2} )",
    highestBid: "Highest Bid",
    putForSale: "List Item",
  ...
  collectionDetail: {
    owners: "Owners",
    notFoundItems: "No items have been found",
  ...
  deleteItemModal: {
    ...
    ifYouAccept:
      "Once you accept this option, the item will be removed from the marketplace and you will not be able to interact with it.",
...
const espLiterals = {
  ...
  collectionDetail: {
    owners: "Propietarios",
    notFoundItems: "No se han encontrado items",
  ...
  deleteItemModal: {
    ...
    ifYouAccept:
      "Una vez aceptes esta opción, el item será eliminado del marketplace y no se va a poder interactuar con el",
