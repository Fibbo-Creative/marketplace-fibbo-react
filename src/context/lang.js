const engLiterals = {
  ...
  buyNowModal: {
    buyItem: "Do you want to buy the item for",
  },
  cancelAuctionModal: {
    cancelAuction: "Cancela Auction",
    cancel: "Cancel",
  ...
  changePriceModal: {
    changePrice: "Change item price",
    updatedItem: "See updated item",
    price: "Price",
  },
  ...
  confirmCreateModal: {
    ...
    viewItem: "See item created",
  },
  createAuctionModal: {
    auctionItem: "Auction item",
    auction: "Put up for auction",
    auctionCorrect: "Item put up for auction successfully",
  ...
  deleteItemModal: {
    ...
    deletedOk: "The item has been successfully deleted",
    ifYouAccept: "Once you accept this option, the item will be removed from the marketplace and you will not be able to interact with it.",
  ...
  FreezeMetadataModal: {
    ...
    freeze: "Freeze",
    viewItem: "See Item",
    infoFreezed: "Your item information has been successfully frozen",
    ifYouAccept: "Once you accept this option, the NFT information cannot be edited and will be stored in a decentralized way in the IPFS protocol",
  ...
  PutForSaleModal: {
    sellNft: "Sell NFT",
    sellItem: "Put Item on Sale",
    viewUpdated: "See updated item",
  },
  RedirectModal: {
  ...
  TransferModal: {
    ...
    send: "Send item",
    sendOk: "Item sent succesfully",
    itemUpdated: "See item updated",
    wallet: "Enter the address to which you want to send it",
  },
  UnlistItemModal: {
    quitItem: "Remove item from market",
    deleteItem: "Remove ítem",
    deletedOk: "Item successfully removed from the market",
    itemUpdated: "See item updated",
    name: "Name:",
    royalties: "Royalties:",
  },
