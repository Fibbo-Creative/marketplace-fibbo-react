...
export default function NftCard({ item, onClick }) {
  return (
    <div
      onClick={onClick}
      className="flex flex-col gap-3 dark:shadow-lg dark:shadow-gray-3  border-2 p-3 rounded-md cursor-pointer hover:shadow-lg hover:border-3 hover:-translate-y-1"
    >
