        ...
        <div className="flex gap-5 items-center  ">
          <div className="hidden lg:flex  items-center p-0 m-0 align-baseline">
            ...
            <div className="flex ">
              ...
              {verifiedAddress && (
                <NavbarItem text={literals.navbar.collections} to="/myCollections" />
              )}

              {!verifiedAddress && (
                <NavbarItem text={literals.navbar.verify} to="/verificate/request" />
              )}
              {/* {verifiedAddress && (
        ...
        {openedMenu && (
          ...
          >
            <div className="flex flex-col gap-10 mt-10 w-full">
              ...
              {verifiedAddress && (
                <NavbarItemMobile text={literals.navbar.collections} to="/myCollections" />
              )}
              {!verifiedAddress && (
                <NavbarItemMobile text={literals.navbar.verify} to="/verificate/request" />
              )}
              {/*  {verifiedAddress && (
