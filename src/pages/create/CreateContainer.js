    ...
    <div className="block p-6  rounded-lg shadow-xl bg-white max-w-md">
      <form >
        ...
        <input class="form-control
          ...
          ease-in-out
          m-0
          focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="formFileSm" type="file" onChange={(e) => onFileSelected(e)}/>
        </div>
        <div className="form-group mb-6">
          <input type="text" 
          value={name}
        ...
        <div className="form-group mb-6">
          <textarea className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding 
        ...
        <button onClick={(e) => createNFT(e)} type="submit" className=" w-full px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight
          ...
          active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Create NFT</button>
      </form>
    </div>
    </div>
