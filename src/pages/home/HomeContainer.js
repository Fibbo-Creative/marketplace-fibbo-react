...
export default function HomeContainer() {
  ...
  return (
    <PageWithLoading loading={false}>
      <div className="w-screen h-full m-0 p-0 b-0  bg-gradient-to-r from-blue-800 to-violet-600 dark:bg-dark-1">
        ...
        <section className="flex flex-col items-center justify-center w-full h-full gap-10 mt-40 ">
          <div className="flex items-center w-11/12 justify-center ">
            <div className="flex items-center justify-center lg:w-1/2  ">
              <img
                className="flex w-3/5 hover:-translate-y-2 hover:opacity-75 cursor-pointer "
                src={laConquista}
              ></img>
            </div>
          </div>
