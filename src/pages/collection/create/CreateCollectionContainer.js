    ...
    <div className="flex mt-[79px] mb-[79px]  w-screen content-center justify-center">
      <div className="flex w-7/12 flex-col  ">
        ...
        <div className="flex flex-col w-full pt-[40px] content-center justify-left">
          <a className="text-lg">
            <b>Imagen principal de la colección</b>
          </a>
          <a className="text-md pt-[20px]">
            {" "}
            Selecciona la imagen de presentación de la colección. Esta imagen se
        ...
        <div className="flex flex-col w-full pt-[40px] content-center justify-left">
          <a className="text-lg">
            <b>Pancarta de la colección</b>
          </a>
          <a className="text-md pt-[20px]">
            {" "}
            Esta imagen aparecerá en la parte superior de la página de tu
        ...
        <div className="flex flex-col w-full pt-[40px] content-center justify-left">
          ...
          <a className="text-md pt-[20px]">
            {" "}
            Personaliza tu URL en OpenSea. Solo puede contener letras
        ...
        <div className="flex flex-col w-full pt-[40px] content-center justify-left">
          ...
          <a className="text-md pt-[20px]">
            {" "}
            La descripción de la colección debe contener un máximo de 1000
            carácteres.{" "}
          </a>
        ...
        <div className="flex flex-col w-full pt-[40px] content-center justify-left">
          ...
          <div className="flex flex-row w-full justify-center items-center ">
            <Icon
              className="flex mt-[20px] mr-[20px]"
